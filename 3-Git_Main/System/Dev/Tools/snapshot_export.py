...
def main():
    ...
    sys.path.insert(0,str(root/'Runtime/Python/Lib/site-packages'));sys.path.insert(0,str(app));from Core.cumulativity import metadata as rules_metadata;from Core.data_policy import snapshot_policy_metadata;from Core.system_history import append_event
    ...
    from Core.sm_repo import ensure_structure,copy_file_verified,append_index
