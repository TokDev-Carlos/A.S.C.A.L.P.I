...
try
{
    ...
    while (true)
    {
        ...
        Console.Write("Senha administrativa (ENTER = instalar/reparar usuario | RECUPERAR = recuperar ADMIN): ");
        ...
        if (string.Equals(password, "RECUPERAR", StringComparison.OrdinalIgnoreCase))
        {
